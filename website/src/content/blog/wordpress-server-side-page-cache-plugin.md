...
description: "How a WordPress server-side page cache plugin sets Cache-Control on anonymous pages and purges the ModPageSpeed cache on publish, instead of caching in PHP."
date: 2026-06-13
...
- [ModPageSpeed vs WP Rocket](/vs/wp-rocket/) — where the cache lives, PHP layer versus server module
- [Running ModPageSpeed with Docker Compose](/blog/run-with-docker-compose/) — standing up the 2.0 worker the plugin talks to
