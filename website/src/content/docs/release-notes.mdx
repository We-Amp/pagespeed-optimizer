...
description: 'ModPageSpeed 2.0 release notes for the frozen predecessor line — the 2.0.x release history and its security updates. Supported until February 7, 2027; migrating to mod_pagespeed 2.1 is recommended.'
order: 71
group: 'Reference'
---
...
This page documents the frozen ModPageSpeed 2.0 line; the current stable
release is **{rel.release.semver}**. The 2.0 Docker and Helm deployments, and
the ASP.NET Core middleware, remain supported until **February 7, 2027** and
receive security updates — new feature work happens on mod_pagespeed 2.1, the
converged line. See the [mod_pagespeed 2.1 release
