...
Use this page for quick lookups. To see how directives fit together into a working setup, read the [configuration reference](/1.1/docs/configuration/); to turn individual optimizations on or off, see [filter selection](/docs/filter-selection/).
