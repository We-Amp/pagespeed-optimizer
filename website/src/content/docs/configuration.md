...
description: 'Reference for ModPageSpeed 2.0 nginx directives, worker flags, and cache tuning. Looking for the mod_pagespeed 1.15 reference? See /1.1/docs/configuration/.'
order: 20
group: 'Configure'
