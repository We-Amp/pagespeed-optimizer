...
Start with **[Upgrading from the open-source mod_pagespeed](/1.1/docs/upgrading-from-open-source/)**,
then see **[What's new in 1.15](/1.1/docs/whats-new/)** for everything that has
...
**[Downloads](/1.1/docs/downloads/)** page.
...
- The [cache](/1.1/docs/caching/) now lives in a file fingerprinted by the
...
- Fixed: when a cache-directory hash bucket filled up entirely with
  ...
  `bucket_full_evictions` [statistic](/1.1/docs/admin-console/#statistics)
...
- Windows/IIS: cache-invalidation updates
  ([purge requests](/1.1/docs/caching/#cache-flushing-and-purging)) after the
...
- The native fetcher (`UseNativeFetcher`, nginx) remains off by default.
  ...
  [HTTPS configuration](/1.1/docs/https-configuration/)). Enabling it requires
...
**[What's new in 1.15](/1.1/docs/whats-new/)** for the narrative version.
