...
description: 'mod_pagespeed 1.15 admin console: statistics, cache inspection, message history, and config. Setup and access control for nginx, Apache, and IIS at /pagespeed_admin/.'
order: 30
group: 'Operations'
...
mod_pagespeed 1.15 includes built-in admin pages for monitoring, configuration inspection, and cache management. Access them at `/pagespeed_admin/` on your server.
...
The 1.15 IIS module logs warnings and errors to the Windows Event Viewer automatically. Open Event Viewer and look under **Windows Logs > Application** for entries from the mod_pagespeed source.
