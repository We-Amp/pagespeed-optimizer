...
export const faqShared: FaqEntry[] = [
  ...
  {
    q: 'Where are the technical answers for running mod_pagespeed?',
    a: 'See <a href="/docs/getting-started/" class="text-interactive hover:text-interactive-hover underline">Getting Started</a>, <a href="/docs/troubleshooting/" class="text-interactive hover:text-interactive-hover underline">Troubleshooting</a>, <a href="/docs/filter-selection/" class="text-interactive hover:text-interactive-hover underline">Filter Selection</a>, <a href="/docs/cache-modes/" class="text-interactive hover:text-interactive-hover underline">Cache modes</a>, <a href="/docs/admin-console/" class="text-interactive hover:text-interactive-hover underline">Admin console</a>, and the <a href="/1.0/" class="text-interactive hover:text-interactive-hover underline">archived 1.0 docs</a>.',
  },
  {
    q: 'Can I run mod_pagespeed under ASP.NET Core?',
    a: 'Yes, on Linux. The <code class="rounded bg-bg-elevated px-1 py-0.5 text-xs">WeAmp.PageSpeed.Sidecar</code> NuGet package adds mod_pagespeed to your Kestrel app via middleware, with a bundled nginx + ngx_pagespeed optimizer running on loopback behind it — <code class="rounded bg-bg-elevated px-1 py-0.5 text-xs">AddPageSpeed()</code> / <code class="rounded bg-bg-elevated px-1 py-0.5 text-xs">UsePageSpeed()</code> wire it in, and a single <code class="rounded bg-bg-elevated px-1 py-0.5 text-xs">dotnet add package</code> pulls the bundled native binaries. It is Linux-only (linux-x64, linux-arm64). See the <a href="/docs/aspnet-getting-started/#the-115-sidecar-weamppagespeedsidecar" class="text-interactive hover:text-interactive-hover underline">ASP.NET Core sidecar guide</a>. For a cross-platform, in-process integration, see <a href="/docs/aspnet-getting-started/" class="text-interactive hover:text-interactive-hover underline">ASP.NET Core Getting Started</a> instead.',
  },
];
