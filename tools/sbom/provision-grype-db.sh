...
# PR. (The r21 readiness audit caught this repo's pin at 68 days old with no
# ratchet — a pin nobody bumps is a gate that has quietly stopped working.)
#
# Kept in sync with the sibling repositories' copies of this script;
# the pin JSON is the same shape.
#
# Usage:
